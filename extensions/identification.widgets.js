...
(function() {    
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: [
			...
			{
				name: "current_window",
				display_name: _t("Current window"),
				type: "text",
			...
			},
			{
				...
				display_name: _t("Steady state start time on speed"),
				type: "text",
				suffix: _t("milliseconds"),
				"required" : true,
				default_value: "800",
			...
			},
			{
				...
				display_name: _t("Motor voltage during current try"),
				type: "text",
				"suffix": _t("V"),
				"required" : true,
				default_value: "6",
			...
			{
				name: "voltage_speed",
				display_name: _t("Motor voltage during speed try"),
				type: "text",
				"suffix": _t("V"),
				"required" : true,
				default_value: "6",
